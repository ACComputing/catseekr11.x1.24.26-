...
class ChatGPTGUI:
    def __init__(self, root):
        ...
        self.btn_new = tk.Button(self.sidebar, text="+  New Chat", bg=self.bg_sidebar, fg="black",
                                 activebackground="#2a2b32", activeforeground="black",
        ...
        # Actions in sidebar
        btn_style = {
            "bg": self.bg_sidebar, "fg": "black", "activebackground": "#2a2b32", 
            "activeforeground": "black", "font": ("Helvetica", 10), "relief": tk.FLAT, 
        ...
        self.btn_send = tk.Button(self.input_frame, text="↑", bg="#ececec", fg="black",
